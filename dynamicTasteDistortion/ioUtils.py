...
def load_time_diff_df(data_type, size, num_users):
...
def load_oracle_matrix(data_type, size, num_users):
    output_path = f"{SIMULATION_PATH}/{data_type}_{size}_n_users={num_users}_oracle.pkl"
