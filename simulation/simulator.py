...
class Simulator:
    def __init__(self, oracle_matrix, model, initial_date, user_timestamp_distribution, user_sample=None):
    ...
    def simulate(
        ...
        for round_idx in tqdm(range(rounds), desc="Processing rounds..."):
            ...
            if (round_idx % 100 == 0):
                boostrapped_df.to_csv(f"data/movielens/no_calibration_sim_up_to_round_{round_idx}")
